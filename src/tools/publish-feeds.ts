import type { AppBskyFeedGenerator, At, Brand, ComAtprotoRepoApplyWrites, ComAtprotoRepoListRecords } from "@atcute/client/lexicons";
...
async function publishFeeds() {
    ...
    for (const labelIdentifier of Object.keys(labelDefinitions)) {
        ...
        // don't want to get myself banned!
        if (
            labelDefinitions[labelIdentifier].locales[0].name === 'loli' ||
            labelDefinitions[labelIdentifier].locales[0].name === 'shota'
        ) {
            continue;
        }
