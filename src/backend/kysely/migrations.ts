...
migrations['001'] = {
    async up(db: Kysely<unknown>) {
        ...
        await db.schema.createIndex('wiki_pages_title_idx').on('wikiPages').column('title').execute();
        ...
        await db.schema.createIndex('tags_name_idx').on('tags').column('name').execute();

        await db.schema.createIndex('tags_category_idx').on('tags').column('category').execute();
        ...
        await db.schema.createIndex('labels_uri_idx').on('labels').column('uri').execute();

        await db.schema.createIndex('labels_cid_idx').on('labels').column('cid').execute();
        ...
        await db.schema.createIndex('followers_rkey_idx').on('followers').column('rkey').execute();

        await db.schema.createIndex('likers_rkey_idx').on('likers').column('rkey').execute();
...
migrations['002'] = {
    async up(db: Kysely<unknown>) {
        await db.schema.dropIndex('labels_cid_idx').ifExists().execute();

        await db.schema.dropIndex('labels_uri_idx').ifExists().execute();

        await db.schema.alterTable('labels').dropColumn('src').execute();

        await db.schema.alterTable('labels').dropColumn('uri').execute();

        await db.schema.alterTable('labels').dropColumn('cid').execute();

        await db.schema.alterTable('labels').dropColumn('val').execute();

        await db.schema.alterTable('labels').dropColumn('neg').execute();

        await db.schema.alterTable('labels').dropColumn('cts').execute();

        await db.schema.alterTable('labels').dropColumn('exp').execute();

        await db.schema.alterTable('labels').dropColumn('sig').execute();
    ...
    async down(db: Kysely<unknown>) {
        ...
        await db.schema.alterTable('labels').addColumn('src', 'text').execute();

        await db.schema.alterTable('labels').addColumn('uri', 'text').execute();
        ...
        await db.schema.alterTable('labels').addColumn('val', 'text').execute();
        ...
        await db.schema.alterTable('labels').addColumn('cts', 'datetime').execute();
