...
interface PrettifyMetadataParams {
    ...
    log: any; // Consider a more specific type if the structure of log objects is known
 ...
 */
export default function prettifyMetadata({ log, context }: PrettifyMetadataParams): undefined | string {
