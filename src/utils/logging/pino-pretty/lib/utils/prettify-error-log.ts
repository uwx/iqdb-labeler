...
import prettifyObject from './prettify-object';

interface PrettifyErrorLogParams {
    /** The error log to prettify. */
    log: object;
 ...
 */
export default function prettifyErrorLog({ log, context }: PrettifyErrorLogParams) {
