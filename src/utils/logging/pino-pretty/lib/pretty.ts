...
import prettifyErrorLog from './utils/prettify-error-log';
import prettifyLevel from './utils/prettify-level';
import prettifyMessage from './utils/prettify-message';
import prettifyMetadata from './utils/prettify-metadata';
import prettifyObject from './utils/prettify-object';
import prettifyTime from './utils/prettify-time';
import filterLog from './utils/filter-log';

import { LEVELS, LEVEL_KEY, LEVEL_NAMES } from './constants';
import type { PrettyContext } from './utils/parse-factory-options';
...
export type LogPrettifierFunc = typeof pretty;
